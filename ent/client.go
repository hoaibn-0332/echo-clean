...
func (c *ArticleClient) QueryAuthor(a *Article) *AuthorQuery {
...
// QueryArticle queries the article edge of a Author.
func (c *AuthorClient) QueryArticle(a *Author) *ArticleQuery {
