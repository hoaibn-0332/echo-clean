...
func (au *ArticleUpdate) SetAuthor(a *Author) *ArticleUpdate {
	return au.SetAuthorID(a.ID)
}
...
// SetAuthor sets the "author" edge to the Author entity.
func (auo *ArticleUpdateOne) SetAuthor(a *Author) *ArticleUpdateOne {
	return auo.SetAuthorID(a.ID)
}
